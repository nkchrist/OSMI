...
The project is available on github <https://github.com/nkchrist/OSMI> and can be installed these ways :

``` r
# install.packages("devtools")
devtools::install_github("https://github.com/nkchrist/OSMI")

library(devtools)
install_github("https://github.com/nkchrist/OSMI")
...
# Local installation with devtools
 library(devtools)
devtools::install_("/Yourpath/OSMI.zip")
```
...
OSMI_on_aging_clock
OSMI_Island: a version of OSMI, in which the island structure in chromoso
```
